...
/**
 * classe che gestisce la finestra di popup per automobile
 * @author micky
 */
public class FinestraPopUpAutomobile extends FinestraPopUp{
    public FinestraPopUpAutomobile(String label1, String label2, String label3, Pannello pannello) {
        super(label1, label2, label3, pannello);
            ...
            public void handle(Event event) {
                ...
                if(tmp1=="" || tmp2 =="" || tmp3==null){
                    ...
                    if(pannelloassociato.add( new Automobile(tmp1,tmp2,tmp3) )){
                        questo.close();
